...
void BrickCell::drawborders(unsigned int bw, const BCSurround &sur, int depth) {
  if (!sur.e) // east edge
    a_rect(wid-bw,bw, bw,hei-2*bw, -depth);

  switch ( 1*sur.e + 16*sur.n + 256*sur.ne) // ne corner
    {
    case 0x000: case 0x100:
      a_tri_nw(wid-bw,0, bw, depth);
      a_tri_se(wid-bw,0, bw, -depth); break;
    case 0x001: case 0x101: a_rect(wid-bw,0, bw,bw, depth); break;
    case 0x010: case 0x110: a_rect(wid-bw,0, bw,bw, -depth); break;
    case 0x011: 
      a_tri_nw(wid-bw,0, bw,-depth);
      a_tri_se(wid-bw,0, bw,+depth); break;
    case 0x111: break;
  ...
  switch ( 1*sur.n + 16*sur.w + 256*sur.nw) // nw corner
    {
    case 0x000: case 0x100: case 0x011:
      a_line_nw_se(0,0, bw, depth/3); // fallthrough
    case 0x001: case 0x010: case 0x101: case 0x110:
      a_rect(0,0, bw,bw, depth); break;
    case 0x111: break;
    }
  ...
  switch (1*sur.w + 16*sur.s + 256*sur.sw) // sw corner
    ...
    case 0x000: case 0x100:
      ...
      a_tri_se(0,hei-bw, bw, -depth); break;
    case 0x001: case 0x101:
      a_rect(0,hei-bw, bw,bw, -depth); break;
    case 0x010: case 0x110:
      a_rect(0,hei-bw, bw,bw, depth); break;
    case 0x011:
      a_tri_nw(0,hei-bw, bw, -depth);
      a_tri_se(0,hei-bw, bw, depth); break;
  ...
  switch (1*sur.s + 16*sur.e + 256*sur.se)
    {
    case 0x000: case 0x011: case 0x100:
      a_line_nw_se(wid-bw,hei-bw, bw, -depth); // fallthrough
    case 0x001: case 0x010: case 0x101: case 0x110:
      a_rect(wid-bw,hei-bw, bw,bw, -depth); break;
    case 0x111: break;
    } 
  }
