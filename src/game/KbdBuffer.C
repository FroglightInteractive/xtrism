    ...
    { state=BufferState(state|(1<<n));
      switch (n)
        ...
        case KN_Right:
          ...
          last=KN_Right;
          break;
        case KN_RotCW: enter(BC_iRotCW); break;
        case KN_RotCCW: enter(BC_iRotCCW); break;
        case KN_Drop: enter(BC_iDrop); break;
        case KN_Zap:
          enter(BC_iZap);
          ...
          break;
        case KN_Pause: enter(BC_iPause); break;
        case KN_LevUp: enter(BC_iLevUp); break;
        case KN_LevDn: enter(BC_iLevDn); break;
        case KN_Quit: enter(BC_iQuit); break;
        case KN_None: case KN_Max: break; // shouldn't happen
        }
    }
  else
    { state=BufferState(state&~(1<<n));
      switch (n)
        ...
        case KN_Zap:
          ...
          break;
        case KN_Drop: case KN_RotCW: case KN_RotCCW: break;
        case KN_Pause: case KN_Quit: break;
        case KN_LevUp: enter(BC_oLevUp); break;
        case KN_LevDn: enter(BC_oLevDn); break;
        case KN_None: case KN_Max: break; // shouldn't happen
        }
    }
  return true;
...
void KbdBuffer::ithreekey(KeyNumber nw) {
  switch (nw)
    ...
    case KN_Zap:
      if (last==KN_Left)
        { enter(BC_iZLeft); enter(BC_oZLeft); }
      else if (last==KN_Right)
        { enter(BC_iZRight); enter(BC_oZRight); }
      break;
    default: break;
    }        
  }
